...
export default function ProductCategoriesLayout({
  ...
  return (
    <div className="bg-gray-100 h-screen flex flex-col md:flex-row overflow-hidden">
      {/* Remove Sidebar Toggle Button if user is on the ProductCategories page in mobile view */}
      {!pathname.includes("/Inventory/ProductCategories") && (
        <button
      ...
      {/* Main Content Area with Scrollable Product Categories */}
